...
def test_index_file_keys_an_absolute_path_off_the_workspace(config, workspace,
                                                           monkeypatch):
    ...
    assert seen["added"][0][0] == ".phrack/reports/report-20260731-120000-code_review.md"
